...
**Input:**
    ...
    fullname(first\_name, sep, last\_name) {
        first\_name + sep + last\_name
    }
...
public class Main {
    ...
    public static String fullname(String firstname, String sep, String last\_name) {
        return first\_name + sep + last\_name;
    }
}
...
**Input:**
    ...
    cond\_repeat("yes", name())
    cond\_repeat("no", "Jane")
